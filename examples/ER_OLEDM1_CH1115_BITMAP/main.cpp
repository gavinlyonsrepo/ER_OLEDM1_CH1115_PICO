...
void Test302(void)
{
	...
	myOLED.OLEDBitmap(22, 5, 84, 24, image2); // no buffer
	busy_wait_ms(10000);
...
void Test303(void)
{
	...
	myOLED.drawBitmap(0, 0, TemperatureImageVA, 16, 16, WHITE, BLACK, sizeof(TemperatureImageVA));
	myOLED.drawBitmap(30, 20, TemperatureImageVA, 16, 16, BLACK, WHITE, sizeof(TemperatureImageVA));
	myOLED.OLEDupdate();
	busy_wait_ms(10000);
}
...
void Test304(void)
{
	...
	myOLED.drawBitmap(20, 10, SunTextImage, 40, 16, WHITE, BLACK, sizeof(SunTextImage));
	myOLED.drawBitmap(80, 20, SunTextImage, 40, 16, BLACK, WHITE, sizeof(SunTextImage));
	myOLED.OLEDupdate();
	busy_wait_ms(10000);
}
...
void Test305(void)
{
	...
	myOLED.setDrawBitmapAddr(true); // for Bitmap Data Vertical  addressed
	myOLED.drawBitmap(4, 0, Signal816, 16, 8, WHITE, BLACK, 16);
	myOLED.drawBitmap(24, 0, Bluetooth88, 8, 8, WHITE, BLACK, 8);
	myOLED.drawBitmap(40, 0, Msg816, 16, 8, WHITE, BLACK, 16);
	myOLED.drawBitmap(64, 0, GPRS88, 8, 8, WHITE, BLACK, 8);
	myOLED.drawBitmap(90, 0, Alarm88, 8, 8, WHITE, BLACK, 8);
	myOLED.drawBitmap(112, 0, Bat816, 16, 8, WHITE, BLACK, 16);
